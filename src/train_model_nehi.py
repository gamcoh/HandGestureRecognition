...
model.add(keras.layers.Dropout(.35))
model.add(keras.layers.Dense(518, activation='relu'))
model.add(keras.layers.Dropout(.35))
model.add(keras.layers.Dense(256, activation='relu'))
model.add(keras.layers.Dropout(.35))
model.add(keras.layers.Dense(128, activation='relu'))
...
checkpoint = keras.callbacks.ModelCheckpoint("nehi_3th_gen.h5", monitor='val_accuracy', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
